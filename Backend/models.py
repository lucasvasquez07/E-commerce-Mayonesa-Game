...
class Usuario(db.Model):
    ...
    juegos = db.relationship('JuegoUsuario', backref='usuario', cascade='all, delete-orphan')
...
class Juego(db.Model):
    ...
    juegos_usuario = db.relationship('JuegoUsuario', backref='juego', cascade='all, delete-orphan')
